-- Simple avatars bucket setup (run this in Supabase SQL Editor)
...
-- 5. Create a simple policy for authenticated users
CREATE POLICY IF NOT EXISTS "Allow authenticated users to manage avatars" 
ON storage.objects
FOR ALL 
USING (
  bucket_id = 'avatars' 
