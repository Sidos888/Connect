...
const PersonalChatPanel = ({ conversation }: PersonalChatPanelProps) => {
  ...
  const { data: messages = [], isLoading: messagesLoading, error: messagesError } = useChatMessages(chatService, conversation.id);
  ...
  // React Query handles message state - no local state needed!
