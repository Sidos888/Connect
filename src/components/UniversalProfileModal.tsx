...
interface UniversalProfileModalProps {
  ...
  showInMenu?: boolean; // If true, shows within menu card section
  onBack?: () => void; // Custom back handler for menu integration
}
...
export default function UniversalProfileModal({ 
        ...
        if (userProfile) {
          ...
          if (account?.id) {
            try {
              ...
              console.error('UniversalProfileModal: Error loading connection data:', connError);
  ...
  // If showing in menu, render without modal wrapper
  if (showInMenu) {
    return (
      <div className="w-full h-full">
        {loading ? (
          ...
          /* Detailed Profile View - Inside Menu */
          <>
            {/* Profile Header */}
          ...
          /* Summary Profile View - Inside Menu */
          <>
  ...
  // Regular modal wrapper for non-menu usage
  return (
